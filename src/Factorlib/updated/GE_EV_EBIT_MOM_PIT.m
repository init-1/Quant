classdef GE_EV_EBIT_MOM_PIT < GlobalEnhanced
    %GE_EV_EBIT_MOM_PIT <a full descriptive name placed here>
    %
    %  Formula:
    %
    %  Description:
    ...
    methods (Access = protected)
        function factorTS = build(o, secIds, startDate, endDate)
            ...
            ebitev = ebit_avg / ev;
            factorTS = o.diff_({o.lagfts(ebitev,'24M'),o.lagfts(ebitev, '12M'), ebitev});
        end
    end
end
