classdef GE_PDIV_12M_RIG < GlobalEnhanced
    %GE_PDIV_12M_RIG <a full descriptive name placed here>
    %
    %  Formula:
    %
    %  Description:
    ...
    methods (Access = protected)
        function factorTS = build(o, secIds, startDate, endDate)
            ...
            DPS_F1_MD = o.loadItem(secIds, 'D000410724', startDate, endDate);
            DPS_F2_MD = o.loadItem(secIds, 'D000410725', startDate, endDate);
            DPS_F3_MD = o.loadItem(secIds, 'D000410726', startDate, endDate);
            ...
            [FY1,FY2,FY3,DPS_F1_MD,DPS_F2_MD,DPS_F3_MD,EPS_FY0_PR] = aligndates(FY1,FY2,FY3,DPS_F1_MD,DPS_F2_MD,DPS_F3_MD,EPS_FY0_PR,gics.dates);
            FWD12 = o.IBES_FWD12(FY1, FY2, FY3, DPS_F1_MD, DPS_F2_MD, DPS_F3_MD);
