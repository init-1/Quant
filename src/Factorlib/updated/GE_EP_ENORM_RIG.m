classdef GE_EP_ENORM_RIG < GlobalEnhanced
    %GE_EP_ENORM_RIG <a full descriptive name placed here>
    %
    %  Formula:
    %
    %  Description:
    ...
    methods (Access = protected)
        function factorTS = build(o, secIds, startDate, endDate)
            ...
            [EPS_FY1,EPS_FY2,EPS_FY3,PR,LG,BY] = aligndates(EPS_FY1,EPS_FY2,EPS_FY3,PR,LG,BY,gics.dates);
