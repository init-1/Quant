classdef REVSAL20D < FacBase
    %REVSAL20D <a full descriptive name placed here>
    %
    %  Formula:
    %
    %  Description:
    ...
    methods (Access = protected)
        function factorTS = build(o, secIds, startDate, endDate)
            ...
            closePrice = backfill(closePrice,o.DCF('5D'),'entry');
            factorTS = Price2Return(closePrice,o.DCF('20D'));
        end
    end
end
